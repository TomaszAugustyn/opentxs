...
OPENTXS_EXPORT auto SupportedChainsNoSync() noexcept -> const UnallocatedSet<Type>&;
OPENTXS_EXPORT auto SupportedChainsFullSync() noexcept -> const UnallocatedSet<Type>&;
